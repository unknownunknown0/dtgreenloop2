...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Header Section */}
      <div className="bg-gradient-to-br from-amber-500 to-orange-600 pt-10 pb-24 px-6 safe-top">
        <motion.div
        ...
        >
          ...
          <h2 className="text-lg text-white/80">Green Loop Management</h2>
        </motion.div>
      </div>
          ...
          <TabsContent value="login">
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all disabled:opacity-70"
              >
